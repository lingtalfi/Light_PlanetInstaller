...
Source Code
===========
See the source code for method [PlanetImportProcessUtil::prepareWishlist](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/Util/PlanetImportProcessUtil.php#L1319-L1326)
