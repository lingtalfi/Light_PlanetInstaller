...
LpiRepositoryUtil::getAppRepository
================



LpiRepositoryUtil::getAppRepository — Returns the app repository.
...
Source Code
===========
See the source code for method [LpiRepositoryUtil::getAppRepository](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/Util/LpiRepositoryUtil.php#L141-L148)
