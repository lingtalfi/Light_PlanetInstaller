...
LpiRepositoryUtil::__construct
================



LpiRepositoryUtil::__construct — Builds the LpiRepositoryUtil instance.
...
public [LpiRepositoryUtil::__construct](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/Util/LpiRepositoryUtil/__construct.md)() : void
...
Next method: [setAppDir](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/Util/LpiRepositoryUtil/setAppDir.md)<br>
