...
Source Code
===========
See the source code for method [ImportCommand::getDescription](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/CliTools/Command/ImportCommand.php#L116-L123)
